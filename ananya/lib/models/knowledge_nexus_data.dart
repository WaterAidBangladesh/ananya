final List<Map<String, String>> knowledgeItems = [
  {
    ...
    "second_description":
        "Menstruation usually begins during puberty, which is a time of significant physical and hormonal changes in girls body. It typically starts between the ages of 10 and 16, but again, there is variation among individuals. The onset of menstruation is known as menarche. It is important to remember that every girls body develops at its own pace, so if you have not started menstruating yet, there is no need to worry. It will happen when your body is ready. \n \nMenstruation stops when a woman reaches menopause, which usually occurs in her late 40s or early 50s. Menopause marks the end of a womans reproductive years. During this time, the ovaries stop releasing eggs, hormone levels change, and menstrual periods cease. The transition to menopause, known as perimenopause, can be accompanied by irregular periods or changes in the length and intensity of menstrual cycles. ",
    "third_description":
  ...
  },
  {
    ...
    "first_description":
        "Menstruation plays an important role in maintaining a girls, healthy reproductive health which is accomplished through the menstrual cycle. The period from the first day of menstruation to the first day of the next period is called the menstrual cycle. \n \n This entire period is regulated by various hormones. A standard menstrual cycle is usually 28 days long, but this period can vary from day to day.",
    "second_description":
        "Now we know that the menstrual cycle plays an important role in a girls healthy reproductive health, but now we dont see how it happens.",
  ...
  },
  {
    ...
    "second_description":
        "Absent or missed periods: When menstrual periods do not occur for three or more months, it is considered a missed period.\n \n Severe menstrual pain: Debilitating cramps that interfere with daily activities and require medication for pain relief.\n \nUnusual menstrual flow: Passing large blood clots during menstruation or experiencing unusually light or scanty flow.",
    "third_description":
        "It is important for teenage girls to be aware of the signs of abnormal menstruation. If you experience any of the mentioned symptoms, it is recommended to seek medical advice. Remember, each persons menstrual cycle is unique, but understanding what is considered abnormal can help you take charge of your menstrual health. Regular monitoring and seeking appropriate medical care ensure your well-being and help maintain a healthy menstrual cycle.",
  },
  {
    "id": "6",
    "question": "What are the common misconceptions about menstruation?",
    "hero_image": "assets/images/missperiod.jpg",
    "first_description":
        "First of all, it needs to be said that there are many misconceptions about menstruation in our society due to lack of science-based information about why menstruation occurs. For example: \n \n1. Menstrual blood is contaminated.n2. It leaves the body because the menstrual blood is contaminated\n3. Menstruation is a matter of shame and a secret.\n4 Menstrual clothing should be hidden, it should not be left to dry in the open\n5. During Menstruation:\n- Fish, meat cannot be eaten\n- Cant go to school\n- Sports cannot be played\n- Do not go out during menstruation, not even after evening, it will require ghosts\n- Stay apart ( For this reason, in some places, menstruation is kept in a separate room.) ",
  },
  {
    "id": "7",
    "question": "What is PMS or Premenstrual Syndrome?",
    "hero_image": "assets/images/pmsimage.jpg",
    "first_description":
        "As the name suggests it occurs before menstruation. PMS is a combination of certain symptoms, such as headaches, breast heaviness, fatigue, irritability or depressed mood or anxiety, bloating, etc. It is understood that these symptoms can be physical and psychological or a combination of both.\n \nAlthough PMS symptoms disrupt daily life, there is little cause for concern as these symptoms go away on their own with the cessation of menstruation.",
  },
  {
    "id": "8",
  ...
  },
  {
    ...
    "second_description":
        "5. Mood swings: Pregnancy can cause changes in mood, with some women experiencing increased irritability or mood swings.  6. Spotting: Light spotting or cramping can occur as the fertilized egg implants in the uterus.  7. Increased urination: The hormone hCG, produced during pregnancy, can cause frequent urination.",
    "third_description":
        "If you suspect you may be pregnant, it\'s important to confirm it with a pregnancy test and to consult a healthcare provider. They can provide further guidance and prenatal care to ensure a healthy pregnancy.",
  },
  {
    "id": "12",
    "question":
